    ...
    >
      ...
      <div className="flex items-center gap-1.5 flex-shrink-0">
        ...
        <button
          ...
          style={{
            color: sidebarOpen ? "#c084fc" : "rgba(148,163,184,0.7)",
            background: sidebarOpen ? "rgba(124,58,237,0.18)" : "rgba(255,255,255,0.04)",
            border: sidebarOpen ? "1px solid rgba(124,58,237,0.4)" : "1px solid rgba(255,255,255,0.06)",
            boxShadow: sidebarOpen ? "0 0 12px rgba(124,58,237,0.2)" : "none",
          }}
        >
